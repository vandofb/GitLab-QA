describe Gitlab::QA::Framework::Factory::Base do
  ...
  describe '.fabricate!' do
    ...
    before do
      allow(Gitlab::QA::Framework::Factory::Product).to receive(:new).and_return(product)
      allow(Gitlab::QA::Framework::Factory::Product).to receive(:populate!).and_return(product)
    end
  ...
  describe '.dependency' do
    ...
    subject do
      Class.new(described_class) do
        dependency(Some::MyDependency, as: :mydep, &:something!)
      end
    end
    ...
    describe 'dependencies fabrication' do
      ...
      before do
        ...
        allow(Gitlab::QA::Framework::Factory::Product).to receive(:new)
        allow(Gitlab::QA::Framework::Factory::Product).to receive(:populate!)
      end
