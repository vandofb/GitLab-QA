describe Gitlab::QA::Framework::Factory::Product do
  let(:factory) do
    Gitlab::QA::Framework::Factory::Base.new
  end

  let(:attributes) do
    { test: Gitlab::QA::Framework::Factory::Product::Attribute.new(:test, proc { 'returned' }) }
  end

  let(:product) { spy('product') }

  before do
    allow(Gitlab::QA::Framework::Factory::Base).to receive(:attributes).and_return(attributes)
  end
